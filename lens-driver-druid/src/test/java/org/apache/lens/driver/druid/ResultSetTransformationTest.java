...
public class ResultSetTransformationTest extends DruidInitDriverTest {
  ...
  static {
    ImmutableMap.Builder<Result, DefaultResultSet> responsesBuilder = ImmutableMap.builder();
  ...
  private void assertResultsAreEqual(DefaultResultSet resultSet1, DefaultResultSet resultSet2) throws LensException {
    ...
    while (resultSet1.hasNext()) {
      ...
      Assert.assertEquals(row1.getValues().size(), row2.getValues().size(), "Row length is different");
