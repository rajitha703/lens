...
public class MockUserGroupLoader implements UserGroupConfigLoader{

  @Override
  public Map<String, String> getUserConfig(String loggedInUser) throws UserGroupLoaderException {
    Map<String, String> userConfigMap = new HashMap<>();
    userConfigMap.put(LensConfConstants.SESSION_USER_GROUPS, "lens-auth-test1");
